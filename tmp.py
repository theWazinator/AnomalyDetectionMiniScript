...
output_path_base = r"C:\Users\jacob\PycharmProjects\AnomalyDetectionMiniScript\0_raw_dataframe.gzip"

df_tmp = pd.read_parquet(path=output_path_base, engine='pyarrow')

#print to CSV
df_tmp.to_csv(path_or_buf=r"C:\Users\jacob\PycharmProjects\AnomalyDetectionMiniScript\0_raw_dataframe.csv", \
             index=False)
