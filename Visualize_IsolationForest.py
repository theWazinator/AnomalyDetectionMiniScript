...
model_folder_name = 'IsolationForest_PyOD/V6'
...
with open(output_path_model_base + ".joblib", "rb") as file:
     iforest = load(file)
...
with open(output_path_stats_base + ".txt", 'w') as file:
    ...
    file.write('\nEstimator Count: ' + str(n_estimators))
    ...
    file.write('\nThreshold: ' + str(iforest.threshold_))
